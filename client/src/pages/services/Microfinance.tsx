    ...
    <div className="min-h-screen">
      ...
      <section className="relative pt-32 pb-20 bg-causeway-forest">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-cover bg-center opacity-20" style={{ backgroundImage: 'url(/images/hero-observatory.jpg)' }} />
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-3xl">
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 bg-causeway-gold/20 rounded-lg flex items-center justify-center">
                <Users className="w-8 h-8 text-causeway-gold" />
              </div>
              <div>
                <h1 className="text-3xl md:text-4xl font-display text-causeway-cream">Microfinance Development</h1>
                <p className="text-causeway-cream/80 font-body-ar text-lg">تطوير التمويل الأصغر</p>
              </div>
            </div>
            <p className="text-xl text-causeway-cream/80 leading-relaxed">
              Supporting the establishment and growth of microfinance institutions with comprehensive development services aligned with international best practices.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-12">
              <div>
                ...
                <div className="prose prose-lg text-causeway-forest/70">
                  <p>Microfinance plays a critical role in financial inclusion and economic development. We support MFIs at every stage of their journey, from establishment to scaling, ensuring they operate sustainably while achieving their social mission.</p>
                  <p>Our approach integrates international best practices with local context, ensuring solutions that work in Yemen's unique operating environment.</p>
                </div>
              </div>
            ...
            <div className="space-y-8">
              <div className="bg-causeway-forest p-8 rounded-lg">
                <h3 className="text-xl font-display text-causeway-cream mb-6">Key Resources</h3>
                <ul className="space-y-3 text-causeway-cream/80 text-sm">
                  <li>• Yemen Microfinance Network</li>
                  <li>• Social Performance Management</li>
                  <li>• Client Protection Principles</li>
                  <li>• MFI Best Practices</li>
                </ul>
              </div>

              <div className="bg-white p-8 rounded-lg shadow-sm">
                <h3 className="text-xl font-display text-causeway-forest mb-4">Request a Briefing</h3>
                <p className="text-causeway-forest/70 text-sm mb-6">Discuss your microfinance development needs.</p>
                <Link href="/contact">
